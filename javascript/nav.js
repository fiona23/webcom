$(function(){	
		...
		$("#nav>li").hover(function(){
							...
							var sub_ul_height = new_height * sub_li_num + 8;
		...
		var nav_container_width = $("#nav_container").css("width");
				...
				{	
					...
					$("#pageMain").css({"width":"90%","padding":"80px 5% 50px 5%","margin-left":"0px"});
					...
					$("#pageMain").css({"width":"69%","padding":"40px 5.93% 50px 4.45%","margin-left":"20%"});
